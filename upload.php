...
// if everything is ok, try to upload file
        ...
        if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
            ...
            $sql = "INSERT INTO tbl_prop(title, price, beds, baths, garages, area, type, status, description, address, latitude, longitude, agent, image) VALUES('".$title."', '".$price."', '".$beds."', '".$baths."', '".$garages."', '".$area."', '".$type."', '".$status."', '".$description."', '".$address."', '".$latitude."', '".$longitude."', '".$agent."', '".$target_file."')";
